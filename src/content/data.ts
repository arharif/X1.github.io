...
export const seedContent: ContentRecord[] = [
  { id: 'c1', topicId: 't-grc', slug: 'grc-foundations', title: 'GRC Foundations', excerpt: 'The operating model behind sustainable security governance.', body: chapter('GRC Foundations'), contentType: 'professional_chapter', status: 'published', tags: ['grc', 'risk'], collectionIds: ['col-grc'], featured: true, favorite: true, metaTitle: 'GRC Foundations', metaDescription: 'Governance and risk foundations.', publishedAt: '2026-01-02T00:00:00.000Z', createdAt: now, updatedAt: now, authorName: 'Arharif', videoUrl: 'https://www.youtube.com/embed/9B9wNf18W7s' },
  { id: 'c2', topicId: 't-grc', slug: 'grc-control-design', title: 'Control Design & Evidence', excerpt: 'Designing evidence-ready controls.', body: chapter('Control Design & Evidence'), contentType: 'professional_chapter', status: 'draft', tags: ['controls'], collectionIds: ['col-grc'], createdAt: now, updatedAt: now, authorName: 'Arharif' },
  { id: 'c3', topicId: 't-iam', slug: 'iam-control-plane', title: 'IAM as Security Control Plane', excerpt: 'Identity-centric architecture patterns.', body: chapter('IAM as Security Control Plane'), contentType: 'professional_chapter', status: 'published', tags: ['iam'], createdAt: now, updatedAt: now, authorName: 'Arharif' },
  { id: 'c4', topicId: 't-pa1', slug: 'freedom-and-identity', title: 'Freedom and Identity in Anime', excerpt: 'Narrative psychology and philosophical motifs.', body: chapter('Freedom and Identity in Anime'), contentType: 'personal_essay', status: 'published', collectionIds: ['col-anime-philosophy'], tags: ['anime', 'philosophy'], featured: true, favorite: true, createdAt: now, updatedAt: now, authorName: 'Arharif' },
  { id: 'c5', topicId: 't-b1', slug: 'book-reflections-systems', title: 'Book Reflections: Systems Thinking', excerpt: 'How books shape decision quality.', body: chapter('Book Reflections: Systems Thinking'), contentType: 'book_note', status: 'published', tags: ['books'], createdAt: now, updatedAt: now, authorName: 'Arharif' },
  { id: 'c6', topicId: 't-h1', slug: 'hobby-learning-loop', title: 'Hobby Learning Loop', excerpt: 'Building joyful routines with feedback loops.', body: chapter('Hobby Learning Loop'), contentType: 'hobby_note', status: 'archived', tags: ['hobbies'], createdAt: now, updatedAt: now, authorName: 'Arharif' },
];
